...
@router.get("/", response_model=List[HistoriqueResponse], include_in_schema=False)
def get_historique(
...
# ═══════════════════════════════════════════════════════════
# POST - Création automatique (✅ CORRIGÉ 307)
# ═══════════════════════════════════════════════════════════
@router.post("", response_model=HistoriqueResponse)
@router.post("/", response_model=HistoriqueResponse, include_in_schema=False)
